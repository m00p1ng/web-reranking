...
public class SearchFilesWithMoreInfo {
    ...
    public static void doPagingSearch(BufferedReader in, IndexSearcher searcher, Query query,
        ...
        Arrays.sort(hits, (ScoreDoc o1, ScoreDoc o2) -> {
            double score1 = 0, score2 = 0;
            try {
                score1 = Double.parseDouble(searcher.doc(o1.doc).get("PageRank"));
                score2 = Double.parseDouble(searcher.doc(o2.doc).get("PageRank"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        while (true) {
            ...
            for (int i = start; i < end; i++) {
                ...
                if (path != null) {
                    ...
                    double score = Double.parseDouble(searcher.doc(hits[i].doc).get("PageRank"));
